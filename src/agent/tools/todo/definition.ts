...
const todoToolParameters = {
    todos: z.array(todoItemSchema).min(2).describe('The updated todo list'),
};

const todoToolInputSchema = z.object(todoToolParameters);

export type TodoToolParameters = z.infer<typeof todoToolInputSchema>;
